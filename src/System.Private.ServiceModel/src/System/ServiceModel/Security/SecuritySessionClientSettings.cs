...
namespace System.ServiceModel.Security
{
    ...
    sealed class SecuritySessionClientSettings<TChannel> : ISecurityCommunicationObject //: IChannelSecureConversationSessionSettings, ISecurityCommunicationObject
    {
        ...
        IAsyncResult ISecurityCommunicationObject.OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state)
        {
            ...
            throw new NotImplementedException("ISecurityCommunicationObject.OnBeginClose");
        }
        ...
        IAsyncResult ISecurityCommunicationObject.OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state)
        {
            ...
            throw new NotImplementedException("ISecurityCommunicationObject.OnBeginOpen");
        }
        ...
        void ISecurityCommunicationObject.OnEndClose(IAsyncResult result)
        {
            ...
            throw new NotImplementedException("ISecurityCommunicationObject.OnEndClose");
        }

        void ISecurityCommunicationObject.OnEndOpen(IAsyncResult result)
        {
            // OperationWithTimeoutAsyncResult.End(result);
            throw new NotImplementedException("ISecurityCommunicationObject.OnEndOpen");
        }
        ...
        internal TChannel OnCreateChannel(EndpointAddress remoteAddress, Uri via)
        {
            ...
            else if (typeof(TChannel) == typeof(IDuplexSessionChannel))
            {
                ...
                throw new NotImplementedException("OnCreateChannel typeof(IDuplexSessionChannel)");
            }
            else
            {
